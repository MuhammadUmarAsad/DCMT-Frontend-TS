        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              name="language"
              render={({ field }) => (
                <FormItem className="flex flex-col migration-1-1">
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col migration-1-1">
                  ...
                  >
                    ...
                    {vendorName === "Dell" && (
                      <SelectContent position="popper">
                        <SelectItem value="Dell z switch">
                          Dell z switch
                        </SelectItem>
                        <SelectItem value="Dell p switch">
                          Dell p switch
                        </SelectItem>
            ...
            <div className="grid content-center max-w-sm gap-2 migration-1-1">
              <Label htmlFor=" align-content: center Input Database config">
